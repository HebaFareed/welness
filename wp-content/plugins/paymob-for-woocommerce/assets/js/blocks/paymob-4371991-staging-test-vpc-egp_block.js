jQuery(function ($) {
    ...
    if (typeof window.wc !== 'undefined' && typeof window.wp !== 'undefined' && typeof window.wc.wcSettings !== 'undefined' && typeof window.wc.wcBlocksRegistry !== 'undefined') {
        const settings = window.wc.wcSettings.getSetting('paymob-4371991-staging-test-vpc-egp_data', {});
        ...
        const Icon = () => {
            return settings.icon
                ? window.wp.element.createElement('img', {
                    src: settings.icon, id: 'paymob-4371991-staging-test-vpc-egp-logo', style: {
                        maxWidth: '70px',
                        float: 'right',
                        paddingTop: '6px'
                    }
        ...
        const Block_Gateway = {
            name: 'paymob-4371991-staging-test-vpc-egp',
        ...
        const css = `
         html[lang="en"] #paymob-4371991-staging-test-vpc-egp-logo {
             float: right !important;
         }
         html[lang="ar"] #paymob-4371991-staging-test-vpc-egp-logo {
