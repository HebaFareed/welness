 ...
 * @since 4.18.1
 */
class AppointmentEndTime extends AbstractAppointmentTime {

	/**
	 * Load variable admin details.
	 */
	public function load_admin_details() {
		$this->description = __( "Displays the appointment end time in your website's timezone. Nothing will be displayed for all-day appointments.", 'woocommerce-appointments' );
	}
	...
	protected function get_target_datetime_value( WC_Appointment $appointment ) {
		$datetime = aw_normalize_date( $appointment->get_end( 'view', true ) );
