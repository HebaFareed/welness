<?php
class WC_Gateway_Accept_installments extends WC_Payment_Gateway
{
    public $id;
    public $enabled;
    public $icon;
    ...
    public $method_public_description;
    public $order_button_text;
    public $notify_url;
    public $supports;
    public $api_has_iframe;
    public $api_has_items;
    public $api_has_delivery;
    public $api_handles_shipping_fees;
    public $api_debug;
    public $title;
    public $description;
    public $api_key;
    ...
    public $iframe_id;
    public $hmac_secret;
    public $gateway_short_code;
    public $integration_currency;

    public function __construct()
    {
        $this->id = 'accept-installments';

        if (!AdminHelper::valid_currency($this->id) || $this->get_option('enabled') == "no") {
            $this->enabled = false;
        }

        $this->icon               = plugins_url('/woo-accept/assets/img/installments.jpg');
        $this->has_fields         = true;
        $this->method_title       = __('Bank Installments');
        $this->method_description = __('Adds an option to pay with Bank Installments by Accept.');
        $this->method_public_description = __('Pay with your Bank Installments.');
        $this->order_button_text  = __('Proceed');
        $this->notify_url         = WC()->api_request_url('wc-accept-installments');
        ...
        add_action('woocommerce_api_wc-accept-installments', array($this, 'callback'));
    }
    ...
    public function process_payment($order_id)
    {
        ...
        if($this->get_option('iframe_url')=='yes')
        {
            $to = "https://accept.paymobsolutions.com/api/acceptance/iframes/$this->iframe_id?payment_token=$key"; 
