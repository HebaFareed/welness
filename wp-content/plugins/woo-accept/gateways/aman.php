<?php
class WC_Gateway_Accept_Aman extends WC_Payment_Gateway
{
    public $id;
    public $enabled;
    public $icon;
    ...
    public function __construct()
    {
        ...
        $this->icon               = plugins_url('/woo-accept/assets/img/aman_installment.png');
        $this->has_fields         = true;
        $this->method_title       = __('Aman Payment Method');
        $this->method_description = __('Adds an option to pay with Aman Payment Method by Accept.');
        $this->method_public_description = __('Pay with your Aman Payment Method.');
        $this->order_button_text  = __('Proceed');
        $this->notify_url         = WC()->api_request_url('wc-accept-aman');
        ...
        add_action('woocommerce_api_wc-accept-aman', array($this, 'callback'));
    }
