...
// Client intake module (CPT, admin UI, thank-you form + AJAX) — extracted 2026-09-08.
require_once __DIR__ . '/includes/class-welness-intake.php';
...
// ═══════════════════════════════════════════════════════════════════════════════
// Multi-Step Checkout — 2-step flow.
// Step 1 (Contact & Billing) is in form-checkout.php template.
// Step 2 (Payment) renders via hooks below.
// ═══════════════════════════════════════════════════════════════════════════════
...
// right column shows only the order summary, and render payment in Step 2.
add_action('wp_loaded', function () {
	remove_action('woocommerce_checkout_order_review', 'woocommerce_checkout_payment', 20);
});

// ── Step 2: Payment (intake steps removed 2026-09-08) ────────────────────

add_action('wellness_checkout_payment_step', 'wellness_step7_render', 10);
function wellness_step7_render()
{
	// Payment is now the 2nd (and final) checkout step.
?>
	<div class="wellness-checkout-step wellness-step-hidden" id="wellness-step-2" data-step="2" role="region" aria-label="<?php echo esc_attr__('Step 2: Payment', 'woodmart-child'); ?>">
		...
		<div class="wellness-step-body">
			...
			<div class="wellness-step-actions">
				<button type="button" class="wellness-btn-back" data-back="1" aria-label="<?php echo esc_attr__('Go back to previous step', 'woodmart-child'); ?>">
...
?>
	<script>
		(function($) {
			...
			function hideAll() {
				for (var i = 1; i <= 2; i++) $steps[i].addClass('wellness-step-hidden');
			}
