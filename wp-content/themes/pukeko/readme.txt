...
Pukeko WordPress Theme, Copyright 2018 WordPress.org.
Pukeko is distributed under the terms of the GNU GPL.
...
Pukeko bundles the following third-party resources:

normalize.css, Copyright 2012-2016 Nicolas Gallagher and Jonathan Neal
**License:** MIT
Source: https://necolas.github.io/normalize.css/

Linearicons icons, Copyright Perxis.com
License: CC BY-SA 4.0
Source: https://linearicons.com/

Simple icons, Copyright simpleicons.org
...
- New: Lowercase/Uppercase main menu and button style option (Appearance/Customize/Theme/Typography).
...
- Bugfix: Optimized blog and single post CSS, is no widgets in blog sidebar.
- Bugfix: Added missing page sidebar (sidebar-page.php).
- Bugfix: Optimized files for the One Click Demo Import plugin (added new folder ...assets/demos).
- Bugfix: Optimized admin Welcome screen files.
- Bugfix: Updated custom logo sizes in functions.php.
